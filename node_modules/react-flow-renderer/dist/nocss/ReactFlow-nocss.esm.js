...
var setOnConnect = function (onConnect) {
    return createAction(SET_ON_CONNECT, {
        onConnect: onConnect,
    });
};
var setOnConnectStart = function (onConnectStart) {
    return createAction(SET_ON_CONNECT_START, {
        onConnectStart: onConnectStart,
    });
};
var setOnConnectStop = function (onConnectStop) {
    return createAction(SET_ON_CONNECT_STOP, {
        onConnectStop: onConnectStop,
    });
};
var setOnConnectEnd = function (onConnectEnd) {
    return createAction(SET_ON_CONNECT_END, {
        onConnectEnd: onConnectEnd,
    });
};
var setElements = function (elements) { return createAction(SET_ELEMENTS, elements); };
var updateNodeDimensions = function (updates) {
    return createAction(UPDATE_NODE_DIMENSIONS, updates);
};
var updateNodePos = function (payload) { return createAction(UPDATE_NODE_POS, payload); };
var updateNodePosDiff = function (payload) { return createAction(UPDATE_NODE_POS_DIFF, payload); };
var setUserSelection = function (mousePos) { return createAction(SET_USER_SELECTION, mousePos); };
var updateUserSelection = function (mousePos) { return createAction(UPDATE_USER_SELECTION, mousePos); };
var unsetUserSelection = function () { return createAction(UNSET_USER_SELECTION); };
var setSelection = function (selectionActive) {
    return createAction(SET_SELECTION, {
        selectionActive: selectionActive,
    });
};
var unsetNodesSelection = function () {
    return createAction(UNSET_NODES_SELECTION, {
        nodesSelectionActive: false,
    });
};
var resetSelectedElements = function () {
    return createAction(RESET_SELECTED_ELEMENTS, {
        selectedElements: null,
    });
};
var setSelectedElements = function (elements) { return createAction(SET_SELECTED_ELEMENTS, elements); };
var addSelectedElements = function (elements) { return createAction(ADD_SELECTED_ELEMENTS, elements); };
var updateTransform = function (transform) { return createAction(UPDATE_TRANSFORM, { transform: transform }); };
...
var initD3Zoom = function (payload) { return createAction(INIT_D3ZOOM, payload); };
var setMinZoom = function (minZoom) { return createAction(SET_MINZOOM, minZoom); };
var setMaxZoom = function (maxZoom) { return createAction(SET_MAXZOOM, maxZoom); };
var setTranslateExtent = function (translateExtent) {
    return createAction(SET_TRANSLATEEXTENT, translateExtent);
};
var setConnectionPosition = function (connectionPosition) {
    return createAction(SET_CONNECTION_POSITION, { connectionPosition: connectionPosition });
};
var setConnectionNodeId = function (payload) { return createAction(SET_CONNECTION_NODEID, payload); };
var setSnapToGrid = function (snapToGrid) { return createAction(SET_SNAPTOGRID, { snapToGrid: snapToGrid }); };
var setSnapGrid = function (snapGrid) { return createAction(SET_SNAPGRID, { snapGrid: snapGrid }); };
var setInteractive = function (isInteractive) {
...
var setNodesDraggable = function (nodesDraggable) {
    return createAction(SET_NODES_DRAGGABLE, { nodesDraggable: nodesDraggable });
};
var setNodesConnectable = function (nodesConnectable) {
    return createAction(SET_NODES_CONNECTABLE, { nodesConnectable: nodesConnectable });
};
var setElementsSelectable = function (elementsSelectable) {
    return createAction(SET_ELEMENTS_SELECTABLE, { elementsSelectable: elementsSelectable });
};
var setMultiSelectionActive = function (multiSelectionActive) {
    return createAction(SET_MULTI_SELECTION_ACTIVE, { multiSelectionActive: multiSelectionActive });
};
var setConnectionMode = function (connectionMode) {
    return createAction(SET_CONNECTION_MODE, { connectionMode: connectionMode });
};
var setNodeExtent = function (nodeExtent) { return createAction(SET_NODE_EXTENT, nodeExtent); };
...
var useStore$1 = function () {
    var store = useStore();
    return store;
};
var useDispatch$1 = useDispatch;
...
var parseNode = function (node, nodeExtent) {
    return __assign(__assign({}, node), { id: node.id.toString(), type: node.type || 'default', __rf: {
...
var parseEdge = function (edge) {
    return __assign(__assign({}, edge), { source: edge.source.toString(), target: edge.target.toString(), sourceHandle: edge.sourceHandle ? edge.sourceHandle.toString() : null, targetHandle: edge.targetHandle ? edge.targetHandle.toString() : null, id: edge.id.toString(), type: edge.type || 'default' });
};
...
var NodeRenderer = function (props) {
    ...
    var visibleNodes = props.onlyRenderVisibleElements
...
var initialZoomPanHelper = {
    ...
    project: function (position) { return position; },
    initialized: false,
};
        ...
        if (d3Selection && d3Zoom) {
            return {
                ...
                project: function (position) {
                    var _a = store.getState(), transform = _a.transform, snapToGrid = _a.snapToGrid, snapGrid = _a.snapGrid;
                    return pointToRendererPoint(position, transform, snapToGrid, snapGrid);
                },
                initialized: true,
            };
    ...
    var NodeWrapper = function (_a) {
        ...
        return (React.createElement(DraggableCore_1$1, { onStart: onDragStart, onDrag: onDrag, onStop: onDragStop, scale: scale, disabled: !isDraggable, cancel: ".nodrag", nodeRef: nodeElement, grid: grid },
            React.createElement("div", { className: nodeClasses, ref: nodeElement, style: nodeStyle, onMouseEnter: onMouseEnterHandler, onMouseMove: onMouseMoveHandler, onMouseLeave: onMouseLeaveHandler, onContextMenu: onContextMenuHandler, onClick: onSelectNodeHandler, "data-id": id },
                React.createElement(Provider$1, { value: id },
...
function reactFlowReducer(state, action) {
    ...
    switch (action.type) {
        case SET_ELEMENTS: {
            ...
            var _g = propElements.reduce(function (res, propElement) {
                if (isNode(propElement)) {
                    var storeNode = state.nodes.find(function (node) { return node.id === propElement.id; });
                    if (storeNode) {
                        var updatedNode = __assign(__assign({}, storeNode), propElement);
                    ...
                    var storeEdge = state.edges.find(function (se) { return se.id === propElement.id; });
                    if (storeEdge) {
                ...
                return res;
            }, nextElements), nextNodes = _g.nextNodes, nextEdges = _g.nextEdges;
            return __assign(__assign({}, state), { nodes: nextNodes, edges: nextEdges });
        }
        case UPDATE_NODE_DIMENSIONS: {
            var updatedNodes = state.nodes.map(function (node) {
                var update = action.payload.find(function (u) { return u.id === node.id; });
                if (update) {
                    ...
                    if (dimensions.width &&
                        ...
                        return __assign(__assign({}, node), { __rf: __assign(__assign(__assign({}, node.__rf), dimensions), { handleBounds: handleBounds }) });
                    }
                }
                return node;
            });
            return __assign(__assign({}, state), { nodes: updatedNodes });
        }
        case UPDATE_NODE_POS: {
            var _h = action.payload, id_1 = _h.id, pos = _h.pos;
            var position_1 = pos;
            if (state.snapToGrid) {
                var _j = state.snapGrid, gridSizeX = _j[0], gridSizeY = _j[1];
                position_1 = {
            ...
            var nextNodes = state.nodes.map(function (node) {
                if (node.id === id_1) {
                    return __assign(__assign({}, node), { __rf: __assign(__assign({}, node.__rf), { position: position_1 }) });
                }
                return node;
            });
            return __assign(__assign({}, state), { nodes: nextNodes });
        }
        case UPDATE_NODE_POS_DIFF: {
            var _k = action.payload, id_2 = _k.id, diff_1 = _k.diff, isDragging_1 = _k.isDragging;
            var nextNodes = state.nodes.map(function (node) {
                var _a;
                if (id_2 === node.id || ((_a = state.selectedElements) === null || _a === void 0 ? void 0 : _a.find(function (sNode) { return sNode.id === node.id; }))) {
                    var updatedNode = __assign(__assign({}, node), { __rf: __assign(__assign({}, node.__rf), { isDragging: isDragging_1 }) });
                    if (diff_1) {
                        updatedNode.__rf.position = {
                            x: node.__rf.position.x + diff_1.x,
                            y: node.__rf.position.y + diff_1.y,
                        };
                    }
                    return updatedNode;
                }
        ...
        case SET_USER_SELECTION: {
            ...
            return __assign(__assign({}, state), { selectionActive: true, userSelectionRect: {
                    width: 0,
                    height: 0,
                    startX: mousePos.x,
                    startY: mousePos.y,
        ...
        case UPDATE_USER_SELECTION: {
            var mousePos = action.payload;
            var startX = (_a = state.userSelectionRect.startX) !== null && _a !== void 0 ? _a : 0;
            var startY = (_b = state.userSelectionRect.startY) !== null && _b !== void 0 ? _b : 0;
            var nextUserSelectRect = __assign(__assign({}, state.userSelectionRect), { x: mousePos.x < startX ? mousePos.x : state.userSelectionRect.x, y: mousePos.y < startY ? mousePos.y : state.userSelectionRect.y, width: Math.abs(mousePos.x - startX), height: Math.abs(mousePos.y - startY) });
            ...
            var selectedElementsUpdate = selectedElementsChanged
                ...
                : {};
            return __assign(__assign(__assign({}, state), selectedElementsUpdate), { userSelectionRect: nextUserSelectRect });
        }
        case UNSET_USER_SELECTION: {
            var selectedNodes = (_c = state.selectedElements) === null || _c === void 0 ? void 0 : _c.filter(function (node) { return isNode(node) && node.__rf; });
            var stateUpdate = __assign(__assign({}, state), { selectionActive: false, userSelectionRect: __assign(__assign({}, state.userSelectionRect), { draw: false }) });
        ...
        case SET_SELECTED_ELEMENTS: {
            ...
            return __assign(__assign({}, state), { selectedElements: selectedElements });
        }
        case ADD_SELECTED_ELEMENTS: {
            var multiSelectionActive = state.multiSelectionActive, selectedElements = state.selectedElements;
            var elements = action.payload;
            var selectedElementsArr = Array.isArray(elements) ? elements : [elements];
            var nextElements = selectedElementsArr;
            if (multiSelectionActive) {
                nextElements = selectedElements ? __spreadArrays(selectedElements, selectedElementsArr) : selectedElementsArr;
            }
            var selectedElementsUpdated = !fastDeepEqual(nextElements, state.selectedElements);
            var nextSelectedElements = selectedElementsUpdated ? nextElements : state.selectedElements;
            return __assign(__assign({}, state), { selectedElements: nextSelectedElements });
        }
        case INIT_D3ZOOM: {
            var _l = action.payload, d3Zoom = _l.d3Zoom, d3Selection = _l.d3Selection, d3ZoomHandler = _l.d3ZoomHandler, transform = _l.transform;
            return __assign(__assign({}, state), { d3Zoom: d3Zoom,
        ...
        case SET_MINZOOM: {
            ...
            (_d = state.d3Zoom) === null || _d === void 0 ? void 0 : _d.scaleExtent([minZoom, state.maxZoom]);
            return __assign(__assign({}, state), { minZoom: minZoom });
        }
        case SET_MAXZOOM: {
            var maxZoom = action.payload;
            (_e = state.d3Zoom) === null || _e === void 0 ? void 0 : _e.scaleExtent([state.minZoom, maxZoom]);
            return __assign(__assign({}, state), { maxZoom: maxZoom });
        }
        case SET_TRANSLATEEXTENT: {
            var translateExtent = action.payload;
            (_f = state.d3Zoom) === null || _f === void 0 ? void 0 : _f.translateExtent(translateExtent);
            return __assign(__assign({}, state), { translateExtent: translateExtent });
        }
        case SET_NODE_EXTENT: {
            var nodeExtent_1 = action.payload;
            return __assign(__assign({}, state), { nodeExtent: nodeExtent_1, nodes: state.nodes.map(function (node) {
                    return __assign(__assign({}, node), { __rf: __assign(__assign({}, node.__rf), { position: clampPosition(node.__rf.position, nodeExtent_1) }) });
                }) });
        }
        case SET_ON_CONNECT:
...
var Wrapper = function (_a) {
    ...
    var contextValue = useContext(ReactReduxContext);
    var isWrappedWithReactFlowProvider = (_c = (_b = contextValue === null || contextValue === void 0 ? void 0 : contextValue.store) === null || _b === void 0 ? void 0 : _b.getState()) === null || _c === void 0 ? void 0 : _c.reactFlowVersion;
